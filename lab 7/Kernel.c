...
function InitFirstProcess ()
	...
	thPtr.Fork(StartUserProcess,"TestProgram4" asInteger)
endFunction
...
function StartUserProcess(arg: int)
	...
	openFile = fileManager.Open("TestProgram4")
...
-----------------------------  Handle_Sys_Read  ---------------------------------
  ...
  function Handle_Sys_Read (fileDesc: int, buffer: ptr to char, sizeInBytes: int) returns int
	var virtAddr, virtPage, offset, copiedSoFar, nextPosInFile, chunkSize, fileSize, destAddr: int
	    openFile: ptr to OpenFile
	    readSuccess: bool
